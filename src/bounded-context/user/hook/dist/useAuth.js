...
var accessTokenStore = zustand_1.create(function (set, get) { return ({
    storage: new AccessTokenStorage_1.PrivatePropertyAccessTokenStorage()
}); });
exports.useAuth = function () {
    var storeToken = function (token) {
        accessTokenStore.getState().storage.store(token);
    };
    var clearToken = function () {
        accessTokenStore.getState().storage.clear();
    };
    return {
...
var ensureToken = function () { return __awaiter(void 0, void 0, void 0, function () {
    var isAuthenticated, storage, isTokenExist, isRefreshRequired, request, accessToken;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                isAuthenticated = useRootAuth_1.useRootAuth().isAuthenticated;
