...
var _axios, _config, _actions, _setCode;
exports.__esModule = true;
exports.AsyncApiBuilder = exports.RejectedForCodeActionCall = void 0;
...
var AsyncApiBuilder = /** @class */ (function () {
     ...
     */
    AsyncApiBuilder.prototype.fetch = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        __classPrivateFieldGet(this, _setCode).call(this, res.code);
                        // 성공하지 못했다면 Actions에서 코드에 따른 핸들러를 호출
                        if (res.code !== ApiCode_1.ApiCode.common.SUCCESS) {
...
_axios = new WeakMap(), _config = new WeakMap(), _actions = new WeakMap(), _setCode = new WeakMap();
